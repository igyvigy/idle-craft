...
public class Settings : MonoBehaviour
{
    ...
    [SerializeField] int lightUpperBound = 36;
    public static int LightUpperBound
    {
        get { return instance.lightUpperBound; }
    }

    [SerializeField] int lightLowerBound = 20;
    public static int LightLowerBound
    {
        get { return instance.lightLowerBound; }
    }
